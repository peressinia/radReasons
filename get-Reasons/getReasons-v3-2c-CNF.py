#!/usr/bin/env Python3
"""Script to extract MIMIC-CXR radiology report REASON FOR EXAM field with CNF filter."""
#
...
OUT_FILE_NAME = 'mimic-reasons-CNF-v3-2.csv'
